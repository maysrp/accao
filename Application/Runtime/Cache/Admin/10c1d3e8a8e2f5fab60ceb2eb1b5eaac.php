	...
	<div class="row">
		<div class="row">
			<div class="panel panel-default">
  			<div class="panel-heading"><h4>用户<img src="/Home/User/avatar/uid/<?php echo ($user[0]); ?>/type/small" class="img-rounded"><?php echo ($user[1]); ?>的评论管理</h4></div>
  				<table class="table">
  					<tr>
  						<th>
  							主题帖子
  					...
  					<?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr id="<?php echo ($vo['cid']); ?>">
  							<td><a href="/Admin/Index/post_comment/pid/<?php echo ($vo['pid']); ?>"><?php echo (pidname($vo['pid'])); ?></a></td>
