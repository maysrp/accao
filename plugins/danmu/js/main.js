...
(function ($) {
    ...
    var DanmuPlayer = function (element, options) {
        ...
        this.$ctrlMain.append('<div class="full-screen   ctrl-btn-right" onclick="launchFullScreen(document.documentElement)"><span class=" glyphicon glyphicon-resize-full" aria-hidden="true"></span></div>');
        ...
        $(this.id + " .danmu-op").on('mouseup touchend', {that: that}, function (e) {
            ...
            $("video")[0].volume=e.target.value / 100;
